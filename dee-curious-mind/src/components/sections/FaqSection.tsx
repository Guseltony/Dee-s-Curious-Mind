          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-6 text-left hover:bg-slate-50/50 transition-colors font-poppins"
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <div className="px-6 pb-6 pt-1 border-t border-slate-50 text-sm md:text-base text-text-secondary leading-relaxed font-inter text-left">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
