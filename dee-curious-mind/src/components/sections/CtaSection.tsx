...
export default function CtaSection() {
  ...
  return (
    <section className="relative w-full py-24 md:py-32 px-6 md:px-8 lg:px-12 text-center text-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-8 relative">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <span className="inline-block px-4 py-1 rounded-full bg-white/10 text-primary-hover text-xs md:text-sm font-bold uppercase tracking-wider">
            Enrollment is Open
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight font-poppins">
            Give Your Child the Perfect Start <br className="hidden sm:inline" />
            in a Home-From-Home Setting
          </h2>
          <p className="text-sm md:text-lg text-slate-300 font-inter max-w-xl mx-auto leading-relaxed">
